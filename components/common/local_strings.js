...
let strings = new LocalizedStrings({
 ...
 zh:{
   ...
   bar: "酒吧",
   theUser: "El usuario",
   sendInvitation: "已經邀請你參加日記",
   touchAccept: "接受邀請點這",
   acceptAlreadyInvitation: "你已經接受了日記邀請",
   hasFollowed: "追蹤你了",
   acceptInvitation: "¿是否接受日記邀請",
   changePhoto: "更改相片",
   eject: "踢出",
   invite: "邀請",
   friendsSuggest: "推薦朋友",
   addThisPlaceToADaily: "添加這個地方在日常",
   visitTheDailies: "參觀這裡的日常!",
   thisUserHasNoDiaries: "這個用戶沒有日記",
   nothingToSeeHere: "這沒東西可看喔",
 }
});
